...
namespace PowerNapWPF.PowerNapService {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="Destination", Namespace="http://schemas.datacontract.org/2004/07/WCFServiceWebRole1")]
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="PowerNapService.IService1")]
    public interface IService1 {
        ...
        PowerNapWPF.PowerNapService.Destination[] Get(string filename);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/Get", ReplyAction="http://tempuri.org/IService1/GetResponse")]
        System.Threading.Tasks.Task<PowerNapWPF.PowerNapService.Destination[]> GetAsync(string filename);
        ...
        int AddAll(string[] filenames, string host, int port);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/AddAll", ReplyAction="http://tempuri.org/IService1/AddAllResponse")]
        System.Threading.Tasks.Task<int> AddAllAsync(string[] filenames, string host, int port);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IService1Channel : PowerNapWPF.PowerNapService.IService1, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Service1Client : System.ServiceModel.ClientBase<PowerNapWPF.PowerNapService.IService1>, PowerNapWPF.PowerNapService.IService1 {
        ...
        public PowerNapWPF.PowerNapService.Destination[] Get(string filename) {
            return base.Channel.Get(filename);
        }
        
        public System.Threading.Tasks.Task<PowerNapWPF.PowerNapService.Destination[]> GetAsync(string filename) {
        ...
        public int AddAll(string[] filenames, string host, int port) {
            return base.Channel.AddAll(filenames, host, port);
        }
        
        public System.Threading.Tasks.Task<int> AddAllAsync(string[] filenames, string host, int port) {
            return base.Channel.AddAllAsync(filenames, host, port);
        }
